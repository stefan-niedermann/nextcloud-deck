package it.niedermann.nextcloud.deck.deprecated.ui.widget.upcoming;
...
import it.niedermann.nextcloud.deck.deprecated.ui.upcomingcards.UpcomingCardsAdapterItem;
import it.niedermann.nextcloud.deck.deprecated.ui.upcomingcards.UpcomingCardsAdapterSectionItem;
import it.niedermann.nextcloud.deck.deprecated.ui.upcomingcards.UpcomingCardsUtil;
...
public class UpcomingWidgetFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        try {
            final List<UpcomingCardsAdapterItem> response = widgetRepository.getCardsForUpcomingCardsForWidget();
