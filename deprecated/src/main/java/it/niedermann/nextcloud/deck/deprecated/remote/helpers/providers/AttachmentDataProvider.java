...
public class AttachmentDataProvider extends it.niedermann.nextcloud.deck.remote.helpers.providers.AbstractSyncDataProvider<Attachment> {
    ...
    public AttachmentDataProvider(it.niedermann.nextcloud.deck.remote.helpers.providers.AbstractSyncDataProvider<?> parent, Board board, Stack stack, FullCard card, List<Attachment> attachments) {
        super(parent);
        this.board = board;
        this.stack = stack;
        this.card = card;
