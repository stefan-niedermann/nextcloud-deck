...
public class AccessControlDataProvider extends it.niedermann.nextcloud.deck.remote.helpers.providers.AbstractSyncDataProvider<AccessControl> {

    private static final Long TYPE_GROUP = 1L;
    private final List<AccessControl> acl;
    private final FullBoard board;

    public AccessControlDataProvider(@Nullable it.niedermann.nextcloud.deck.remote.helpers.providers.AbstractSyncDataProvider<?> parent, FullBoard board, List<AccessControl> acl) {
        super(parent);
        this.board = board;
        this.acl = acl;
    }
