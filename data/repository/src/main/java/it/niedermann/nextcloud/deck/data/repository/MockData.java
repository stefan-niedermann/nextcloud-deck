...
public interface MockData {
    ...
    List<Card> MOCK_CARDS = List.of(
            ...
            new Card(new Card.ID(7), null, new Column.ID(3), LocalDateTime.now(), 7, "Card-Title #7", "Card-Description 7 Lorem Ipsum Dolor sit Amet", Collections.emptySet(), Collections.emptySet(), Collections.emptyList(), LocalDateTime.now(), null, null, null, false, false, 0, 0),
            ...
            new Card(new Card.ID(9), null, new Column.ID(9), LocalDateTime.now(), 9, "Card-Title #9", "Card-Description 9 Lorem Ipsum Dolor sit Amet", Collections.emptySet(), Collections.emptySet(), Collections.emptyList(), LocalDateTime.now(), null, null, null, false, false, 0, 0)
    );
