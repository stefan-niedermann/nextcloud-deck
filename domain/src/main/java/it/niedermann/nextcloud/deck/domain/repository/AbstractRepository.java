...
public abstract class AbstractRepository {
    ...
    protected AbstractRepository(@NonNull DatabaseAdapter databaseAdapter, @NonNull SyncAdapter syncAdapter) {
        this(databaseAdapter, syncAdapter,
    ...
    private AbstractRepository(@NonNull DatabaseAdapter databaseAdapter,
                               @NonNull SyncAdapter syncAdapter,
