...
@Command(name = "csv",
        ...
        description = "Export board as CSV")
public class ExportCsvCmd implements Callable<Integer> {

    private static final Logger logger = Logger.getLogger(ExportCsvCmd.class.getName());
    ...
    public Integer call() {
        try {
            ...
            final var csv = Maybe.fromPublisher(exportBoardUseCase.toCsv(finalBoardId)).blockingGet();
