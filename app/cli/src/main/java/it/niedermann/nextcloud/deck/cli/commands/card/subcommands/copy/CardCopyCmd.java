...
@Command(name = "copy",
        ...
        description = "Copy a card to another column")
public class CardCopyCmd implements Callable<Integer> {

    private static final Logger logger = Logger.getLogger(CardCopyCmd.class.getName());
    ...
    public Integer call() {
        try {
            ...
            copyCardUseCase.execute(finalCardId, finalColumnId, order).join();
            System.out.println("Card copied.");
