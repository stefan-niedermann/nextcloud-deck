...
public class CardDeleteCmd implements Callable<Integer> {

    private static final Logger logger = Logger.getLogger(CardDeleteCmd.class.getName());
    ...
    public Integer call() {
        try {
            ...
            deleteCardUseCase.execute(cardId).join();
