...
@Command(name = "odt",
        ...
        description = "Export board as ODT (OpenDocument Text)")
public class ExportOdtCmd implements Callable<Integer> {

    private static final Logger logger = Logger.getLogger(ExportOdtCmd.class.getName());
    ...
    public Integer call() {
        try {
            ...
            final var odt = Maybe.fromPublisher(exportBoardUseCase.toOdt(finalBoardId)).blockingGet();
