...
@Command(name = "odt",
        ...
        description = "Export card as ODT")
public class CardExportOdtCmd implements Callable<Integer> {

    private static final Logger logger = Logger.getLogger(CardExportOdtCmd.class.getName());
    ...
    public Integer call() {
        try {
            ...
            final var odt = Maybe.fromPublisher(exportCardUseCase.toOdt(finalCardId)).blockingGet();
