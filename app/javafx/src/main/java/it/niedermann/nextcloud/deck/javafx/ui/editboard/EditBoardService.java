...
public class EditBoardService extends Store<EditBoardService.State, EditBoardService.Action> implements
    ...
    public interface Factory {
        EditBoardService create(State initialState);
    }
