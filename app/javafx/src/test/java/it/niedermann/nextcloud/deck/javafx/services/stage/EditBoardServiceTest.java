...
class EditBoardServiceTest {
    ...
    void setUp() {
        ...
        editBoardService = new EditBoardService(
                storeLogger,
                getBoardUseCase,
                listCardsUseCase,
                addColumnUseCase,
    ...
    void testGetBoard() {
        ...
        editBoardService.getBoard().subscribe(testSubscriber);
    ...
    void testOnAddColumn() {
        editBoardService.onAddColumn("New Column");
