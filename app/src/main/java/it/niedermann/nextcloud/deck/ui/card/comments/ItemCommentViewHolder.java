...
public class ItemCommentViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(@NonNull FullDeckComment comment, @NonNull Account account, @NonNull ViewThemeUtils utils, @NonNull MenuInflater inflater, @NonNull CommentDeletedListener deletedListener, @NonNull CommentSelectAsReplyListener selectAsReplyListener, @NonNull FragmentManager fragmentManager, @NonNull Consumer<CharSequence> editListener) {
        ...
        DrawableCompat.setTint(binding.notSyncedYet.getDrawable(), utils.getOnPrimaryContainer(binding.notSyncedYet.getContext()));
        ...
        if (comment.getParent() == null) {
            ...
            binding.parentBorder.setBackgroundColor(utils.getOnPrimaryContainer(binding.notSyncedYet.getContext()));
