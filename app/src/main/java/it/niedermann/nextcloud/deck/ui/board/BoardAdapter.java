...
public class BoardAdapter extends ArrayAdapter<Board> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (board != null) {
            ...
            boardName.setCompoundDrawables(ViewUtil.getTintedImageView(context, R.drawable.circle_grey600_36dp, String.format("#%06X", (0xFFFFFF & board.getColorInt()))), null, null, null);
        } else {
