...
public class TakePhotoViewModel extends BaseViewModel {
    ...
    @NonNull
    private final MutableLiveData<Integer> cameraSelectorToggleButtonImageResource = new MutableLiveData<>(R.drawable.ic_outline_mobile_camera_front_24);
    @NonNull
    ...
    public void toggleCameraSelector() {
        if (this.cameraSelector == DEFAULT_BACK_CAMERA) {
            ...
            this.cameraSelectorToggleButtonImageResource.postValue(R.drawable.ic_outline_mobile_camera_rear_24);
        } else {
            this.cameraSelector = DEFAULT_BACK_CAMERA;
            this.cameraSelectorToggleButtonImageResource.postValue(R.drawable.ic_outline_mobile_camera_front_24);
        }
    }
    ...
    public LiveData<Integer> getTorchToggleButtonImageResource() {
        return new ReactiveLiveData<>(isTorchEnabled())
                .map(enabled -> enabled
                        ? R.drawable.ic_outline_flash_off_24
