...
public class MarkdownEditor extends WebView {
    ...
    public MarkdownEditor(@NonNull Context context) {
        super(context);
        init();
    }

    @SuppressLint({"SetJavaScriptEnabled", "JavascriptInterface", "AddJavascriptInterface" })
    public MarkdownEditor(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    @SuppressLint("SetJavaScriptEnabled")
    public MarkdownEditor(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setText(String textToSetOnPageFinished) {
        if (pageFinished) {
            ...
            evaluateJavascript("setText(`" + newText + "`);", value -> {});
        } else {
    ...
    public void setEnabled(boolean enabled) {
        if (pageFinished) {
            evaluateJavascript("setEnabled(" + this.enabledStateOnPageFinished + ");", value -> {});
        } else {
